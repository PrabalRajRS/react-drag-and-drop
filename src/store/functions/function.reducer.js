...
export const circle = <div style={{ height: "20px", width: "20px", backgroundColor: "red", borderRadius: "50%", margin: "3px" }} />
export const rectangle = <div style={{ height: "20px", width: "20px", backgroundColor: "blue", margin: "3px" }} />
